        ...
        <>
          ...
          <div className="flex pt-0">
            ...
            <div className="flex pl-5">
              <Button label={Title.submit} disabled={!(startDate && endDate && type)} onClick={() => {navigate('/dashboard/report/non-auction/detail', {'name': "hello"}) ;console.log(startDate); console.log(endDate)}}></Button>
            </div>
          </div>

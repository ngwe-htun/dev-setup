                            ...
                            <Row>
                                <Col xs={3}>
                                    <Form.Select onChange={(e) => filterNrcTownships(e.target.value)}>
                                        {
                                            nrcRegions.map(item => <option key={item.id} value={item}>{item}</option>)
                                        }
                                    </Form.Select>
                                </Col>
                                <Col xs={3}>
                                    <Form.Select>
                                        {
                                            nrcTownships.map(item => <option key={item.id} value={item}>{item.township_mm}</option>)
                                        }
                                    </Form.Select>
                                </Col>
                                <Col xs={3}>
